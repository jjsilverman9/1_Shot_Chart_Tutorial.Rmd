---
title: "NBA & Soccer Heatmaps Tutorial"
...
# NBA Data
```{r} 
#Suns 2021 playoffs chris paul heat map
...
# NBA Heatmap
```{r}
palette <- paletteer::paletteer_d("RColorBrewer::YlOrRd", direction = -1) #change colors with RColorBrewer

p1 <- plot_court(court_themes$ppt) + 
  geom_density_2d_filled(player, mapping = aes(x=x,y=y,fill = ..level..,), #darker areas of red = where most shots are taken
                         contour_var = "ndensity", breaks = seq(0.1, 1.0, length.out = 10), alpha = .5) +  #how bright it is
